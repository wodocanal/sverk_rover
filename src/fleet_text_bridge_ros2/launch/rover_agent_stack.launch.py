...
def generate_launch_description():
    bridge = Node(package='fleet_text_bridge_ros2', executable='bridge_node', name='fleet_text_bridge', output='screen', parameters=[{
    ...
    agent = IncludeLaunchDescription(PythonLaunchDescriptionSource(PathJoinSubstitution([FindPackageShare('rover_agent_mcp'), 'launch', 'agent_mcp.launch.py'])))
    return LaunchDescription([bridge, agent])
